...
import postgres.DefaultSchema;
import postgres.Keys;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> EXTERNAL_ID = createField(DSL.name("EXTERNAL_ID"), SQLDataType.VARCHAR(32), this, "");

    /**
     * The column <code>users.NAME</code>.
     */
    public final TableField<UsersRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(32), this, "");

    /**
     * The column <code>users.LAST_NAME</code>.
     */
    public final TableField<UsersRecord, String> LAST_NAME = createField(DSL.name("LAST_NAME"), SQLDataType.VARCHAR(32), this, "");
